jQuery( document ).ready(function() {
    ...
    jQuery( "#estimate" ).on( "click", function() {
        ...
        jQuery.post( "index.php?option=com_recruit&task=requesthr.estimate&type="+type_id+"&jform_employee_id="+jform_employee_id+"&jform_typeemployee_id="+jform_typeemployee_id+"&jform_count="+jform_count+"&jform_start_date="+start_date+"&jform_id="+id , function(response) {
