...
<form action="<?php echo JRoute::_('index.php');?>"
      method="post" name="credit-form" id="credit-form" class="form-validate">
    ...
    <input type="hidden" name="option" value="com_credit" />
    <input type="hidden" name="task" value="credit.submit" />
