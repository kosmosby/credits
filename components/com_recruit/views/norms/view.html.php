 ...
 * @since  0.0.1
 */
class RecruitViewNorms extends JViewLegacy
{
	/**
    ...
    protected function addToolBar()
    {
        ...
        JToolbarHelper::addNew('norm.add','Создать норматив');
        JToolBarHelper::deleteList('', 'norm.delete', 'Удалить');
