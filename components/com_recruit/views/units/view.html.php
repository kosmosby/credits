 ...
 * @since  0.0.1
 */
class RecruitViewUnits extends JViewLegacy
{
	/**
    ...
    protected function addToolBar()
    {
        ...
        JToolbarHelper::addNew('unit.add','Создать подразделение');
        JToolBarHelper::deleteList('', 'units.delete', 'Удалить');
