...
class RecruitModelNorms extends JModelList
{
    /**
     * Constructor.
     *
    ...
    protected function getListQuery()
    {
        ...
        $query->select(
            $this->getState(
                'list.select',
                'a.*, b.name as typeemployee_name'
            )
        );
        $query->from('#__recruit_norms AS a, #__recruit_typeemployee as b WHERE b.id = a.typeemployee_id');
...
//        echo "</pre>";
    ...
    public function getTable($type = 'Norms', $prefix = 'RecruitTable', $config = array())
    {
